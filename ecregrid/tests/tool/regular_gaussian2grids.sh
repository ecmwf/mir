...
$minmax $data/$file $out/$x
echo ------------------------------
echo "GG to LL Subarea 2 done"
#
#
echo ------------------------------
echo "GG to LL Subarea 3 ..."
echo ------------------------------
ll=$ll1
a=$area1
...
$minmax $data/$file $out/$x
echo ------------------------------
echo "GG to cellcentred LL done"
#
echo ------------------------------
