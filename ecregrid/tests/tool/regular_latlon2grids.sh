...
#export ECREGRID_DUMP_TO_FILE="./regular_latlon2grids.dat"
...
echo "******************************"
echo "Upper Regular LL to grids ****"
echo "******************************"

files="upper_air_latlon.grib1"
...
#
echo ------------------------------
echo "LL to cellcentred LL ..."
echo ------------------------------
ll=$ll1
x=y_$file-ll-cellcentred.grib
$tool -i $data/$file -o $out/$x -l $ll -y cellcentred
$compare $data_ref/$x $out/$x
$minmax $data/$file $out/$x
echo ------------------------------
echo "LL to cellcentred LL done"
#
echo ------------------------------
