...
// For grib headers
    ...
    virtual double   latPole()     const {
        return 0;
    }
    virtual double   lonPole()     const {
        return 0;
    }
    virtual bool     reduced()     const {
        return false;
    }
...
//
    ...
    virtual string   lsmFileType() const  {
        return "grib";
    }
...
//---------------------------------------------------------------
    ...
    virtual int lengthOfFirstLatitude() const  {
        return westEastNumberOfPoints();
    } ;
    virtual int lengthOfLastLatitude() const   {
        return westEastNumberOfPoints();
    } ;
