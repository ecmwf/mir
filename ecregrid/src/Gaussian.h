...
private:
	...
	virtual double westEastIncrement()   const { return 90.0 / gaussianNumber_; };
        	double northSouthIncrement() const { return 90.0 / gaussianNumber_; };
	int     poleEquatorNumberOfPoints()  const { return gaussianNumber_;}
	virtual string   gridType()          const { return "gaussian"; }
