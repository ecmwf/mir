...
// -- Methods
    ...
    int lengthOfFirstLat() const  {
        return gridDefinition_[0];
    } ;
    int lengthOfLastLat() const   {
        return gridDefinition_[gridLatNumber_ -1];
    } ;
    const vector<long>& gridDefinition() const {
