...
// -- Overridden methods
	...
	virtual string   composedName()  const { return "regular_ll"; }
...
// -- Class methods
    ...
    virtual double calculateWestEastIncrement(double east, double west, double inc, long npts) const { return LatLon::calculateWestEastIncrement(east, west, inc, npts); }
