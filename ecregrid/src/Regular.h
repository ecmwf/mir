...
// -- Methods
	...
	unsigned long calculatedNumberOfPts() const { return northSouthNumberOfPoints_ * westEastNumberOfPoints_; } ;
	unsigned long calculatedNumberOfPoints() const { return calculatedNumberOfPoints_; } ;
	
	int northSouthNumberOfPts() const { return northSouthNumberOfPoints_; }
	int westEastNumberOfPts()   const { return westEastNumberOfPoints_; }
