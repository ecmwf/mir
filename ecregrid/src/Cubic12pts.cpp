...
inline double f2(double alpha) {
    return ((alpha + 1.0) * (alpha - 2.0) * (alpha - 1.0)) / 2.0;
}
inline double f3(double alpha) {
    return - ((alpha + 1.0) * (alpha - 2.0) * alpha) / 2.0;
}
inline double f4(double alpha) {
    return (alpha * (alpha - 1.0) * (alpha + 1.0))/6.0;
}
