...
#ifndef mir_action_interpolate_Gridded2OctahedralGG_h
#define mir_action_interpolate_Gridded2OctahedralGG_h
...
class Gridded2OctahedralGG : public Gridded2UnrotatedGrid {
public:
    // -- Exceptions
    // None
    ...
    virtual ~Gridded2OctahedralGG() override;
