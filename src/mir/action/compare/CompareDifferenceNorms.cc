...
struct ReportDifferencesOnFieldsNorms :
        ...
        statistics::ScalarValuepNormsFn< double > {
public:
    ...
    void reset() {
        ...
        statistics::ScalarValuepNormsFn< double >::reset();
    }
    ...
    bool operator()(const double& v) {
        return statistics::ScalarValuepNormsFn< double >::operator()(v);
    }
    bool operator()(const double& v1, const double& v2) {
        return statistics::CountMissingValuesFn< double >::operator()(v1, v2)
            && statistics::ScalarValuepNormsFn < double >::operator()(std::abs(v1-v2));
    }
