...
class LocalShScalarToRegularLL : public LocalShScalarToGridded {
public:
    ...
    LocalShScalarToRegularLL(const param::MIRParametrisation&);

    // -- Destructor

    virtual ~LocalShScalarToRegularLL(); // Change to virtual if base class
