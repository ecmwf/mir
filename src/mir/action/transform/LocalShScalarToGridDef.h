...
class LocalShScalarToGridDef : public LocalShScalarToGridded {
public:
    ...
    LocalShScalarToGridDef(const param::MIRParametrisation&);

    // -- Destructor

    virtual ~LocalShScalarToGridDef(); // Change to virtual if base class
