...
#ifndef mir_action_transform_ShToReducedGG_h
#define mir_action_transform_ShToReducedGG_h
...
class ShToReducedGG : public ShToGridded, Invtrans {
public:
    ...
    ShToReducedGG(const param::MIRParametrisation&);
