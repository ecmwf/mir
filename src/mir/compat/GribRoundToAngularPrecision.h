...
#ifndef mir_compat_GribRoundToAngularPrecision_h
#define mir_compat_GribRoundToAngularPrecision_h
...
class GribRoundToAngularPrecision : public GribCompatibility {
public:

    GribRoundToAngularPrecision(const std::string&);
