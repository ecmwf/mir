...
PredicateBinop::PredicateBinop(const std::string& name,
                           Predicate* arg1,
                           Predicate *arg2):
    PredicateFunction(name, arg1, arg2) {

}

PredicateBinop::~PredicateBinop() {
}

void PredicateBinop::print(std::ostream& out) const {
