...
void StructuredLinear::assemble(WeightMatrix& W, const atlas::grid::StructuredGrid& in, const util::MIRGrid& out) const {
    ...
    triplets_t triplets;
    triplets.reserve(3 * gout.size());

    index_t i = 0;
    for (atlas::PointLonLat p : gout.lonlat()) {
