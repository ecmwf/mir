...
void NearestLSMSingleKDTree::assemble(util::MIRStatistics&,
    ...
    eckit::Log::debug<LibMir>() << "NearestLSMSingleKDTree compute masked/not-masked search trees " << timer.elapsed() - here << std::endl;
    ...
    eckit::Log::debug<LibMir>() << "NearestLSMSingleKDTree search nearest neighbours matching in/output masks " << timer.elapsed() - here << std::endl;
