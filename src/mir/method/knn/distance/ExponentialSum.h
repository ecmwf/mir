...
/**
 * Calculates the sum of the values weighted (multiplied) by the following:
 ...
 */
struct ExponentialSum : DistanceWeighting {
    ExponentialSum(const param::MIRParametrisation&);
