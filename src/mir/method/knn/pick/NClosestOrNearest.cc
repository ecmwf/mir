...
void NClosestOrNearest::pick(const search::PointSearch& tree,  const PointXYZ& p,
    ...
    auto nearest2  = PointXYZ::distance2(p, closest.front().point().to_xyz());
    auto farthest2 = PointXYZ::distance2(p, closest.back().point().to_xyz());
