...
#ifndef mir_method_knn_pick_NClosestWithLowestIndex_h
#define mir_method_knn_pick_NClosestWithLowestIndex_h
...
struct NClosestWithLowestIndex : Pick {
    NClosestWithLowestIndex(const param::MIRParametrisation&);
