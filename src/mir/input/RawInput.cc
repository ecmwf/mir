...
data::MIRField RawInput::field() const {
    ...
    // eckit::Log::trace<MIR>() << "RawInput::field: " << field << eckit::newl;
...
bool RawInput::has(const std::string &name) const {
    eckit::Log::trace<MIR>() << ">>>>>>>>>>>>> RawInput::has (" << name << ")" << eckit::newl;
...
bool RawInput::get(const std::string &name, std::string &value) const {
    eckit::Log::trace<MIR>() << ">>>>>>>>>>>>> RawInput::get string (" << name << ")" << eckit::newl;
...
bool RawInput::get(const std::string &name, bool &value) const {
    eckit::Log::trace<MIR>() << ">>>>>>>>>>>>> RawInput::get bool (" << name << ")" << eckit::newl;
    return false;
}

bool RawInput::get(const std::string &name, long &value) const {
    eckit::Log::trace<MIR>() << ">>>>>>>>>>>>> RawInput::get long (" << name << ")" << eckit::newl;
...
bool RawInput::get(const std::string &name, double &value) const {
    eckit::Log::trace<MIR>() << ">>>>>>>>>>>>> RawInput::get double (" << name << ")" << eckit::newl;
...
bool RawInput::get(const std::string &name, std::vector<long> &value) const {
    eckit::Log::trace<MIR>() << ">>>>>>>>>>>>> RawInput::get vector<long> (" << name << ")" << eckit::newl;
...
bool RawInput::get(const std::string &name, std::vector<double> &value) const {
    ...
    eckit::Log::trace<MIR>() << ">>>>>>>>>>>>> RawInput::get vector<double> (" << name << ")" << eckit::newl;
    return false;
}
