...
#include "mir/caching/interpolator/MappedMemoryLoader.h"
...
MappedMemoryLoader::MappedMemoryLoader(const param::MIRParametrisation& parametrisation, const eckit::PathName& path)
    : InterpolatorLoader(parametrisation, path), fd_(-1), address_(0), size_(0) {
...
namespace {
static InterpolatorLoaderBuilder<MappedMemoryLoader> loader1("mapped-memory");
static InterpolatorLoaderBuilder<MappedMemoryLoader> loader2("mmap");
}
