...
##################################################################################
# "emoslib_interpolation_methods" specifies the interpolation methods enforced
# in EMOSLIB. We use this dict as a lookup when running the ecRegrid MARS
# client in order to steer it to use the same method
#


emoslib_interpolation_methods = {
    "reg_ll": {

        "reg_ll": "bilinear",   # e.g. for reg_ll to reg_ll we use bilinear
        "reg_gg": "bilinear",
        "rot_reg_ll": "cubic",
              },
    ...
    "red_ll": {
        ...
        ### not implemented yet       "reg_ll": "doublelinearadjusted",
              },
...
##################################################################################
# "emoslib_lsm_source" allows use to steer ecRegrid to use the
# same LSM methods used in EMOS lib to ensure fair comparison.
#
emoslib_lsm_source = {
